...
;(function(win, lib) {
    ...
    function refreshRem(){
        ...
        var rem = width / (designPixel/100); //计算最终还原到设计图上的比例，从而设置到文档上,稿件除以100，分成7.5份，一份刚好是100px，之所以设置除以100，因为除以10，最小像素12px限制了文档的字体大小
        docEl.setAttribute('data-rate', width/designPixel);
